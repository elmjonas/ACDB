...
mkdir $f
for pkl in ../Articles/myllys19_sa_multibase_chrg/DLPNO_vtw16/database.pkl ../Articles/acdb_private/kubecka_1/database.pkl ../Articles/acdb_private/myllys_1/database.pkl ../Articles/acdb_monomers/DLPNO_vtw16/database.pkl ../Articles/besel19_sa_am_chrg/database.pkl ../Articles/kubecka19_sa_gd/database.pkl
do
...
mkdir $f
for pkl in ../Articles/acdb_private/elm_1/database.pkl ../Articles/acdb_old/DLPNO_vnw09/database.pkl ../Articles/shen19_msa/database.pkl ../Articles/clusteromics_I_sa_multibase/DLPNO/database.pkl ../Articles/rosati21_sa_msa/database.pkl ../Articles/acdb_monomers/DLPNO_vnw09/database.pkl ../Articles/rasmussen20_sa_w/database.pkl ../Articles/rasmussen22_sa_msa_dma/NormalPNO/database.pkl ../Articles/chen20_msa/database.pkl ../Articles/clusteromics_II_msa_multibase/database.pkl ../Articles/clusteromics_IV_sa_msa_nta_multibase/database_s1.pkl ../Articles/clusteromics_IV_sa_msa_nta_multibase/database_s2.pkl ../Articles/clusteromics_IV_sa_msa_nta_multibase/database_s3.pkl
do
  JKQC $pkl -cut elout $M -pass lf 0 -out `newf` -noex
done
JKQC $f/f_*.pkl -noex -out $f/database.pkl
