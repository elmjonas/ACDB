...
mkdir $f
for pkl in ../Articles/clusteromics_III_sa_msa_multibase/database.pkl ../Articles/acdb_private/elm_1/database.pkl ../Articles/acdb_old/DLPNO_vnw09/database.pkl ../Articles/shen19_msa/database.pkl ../Articles/acdb_monomers/DLPNO_vnw09/database.pkl ../Articles/acdb_monomers/DLPNO_vnw16/database.pkl ../Articles/clusteromics_V_sa_msa_nta_fa_multibase/database_s3.pkl ../Articles/clusteromics_V_sa_msa_nta_fa_multibase/database_s2.pkl ../Articles/clusteromics_V_sa_msa_nta_fa_multibase/database_s1.pkl ../Articles/clusteromics_IV_sa_msa_nta_multibase/database_s1.pkl ../Articles/clusteromics_IV_sa_msa_nta_multibase/database_s2.pkl ../Articles/clusteromics_IV_sa_msa_nta_multibase/database_s3.pkl ../Articles/clusteromics_I_sa_multibase/DLPNO/database.pkl ../Articles/kubecka23_sa_multibase/Xie-SI/database.pkl ../Articles/kubecka23_sa_multibase/DLPNO_DFT/database.pkl ../Articles/fomete23_sa_dma_malonic/database.pkl ../Articles/rosati21_sa_msa/database.pkl ../Articles/rasmussen20_sa_w/database.pkl ../Articles/rasmussen22_sa_msa_dma/database.pkl ../Articles/chen20_msa/database.pkl ../Articles/clusteromics_II_msa_multibase/database.pkl 
do
  JKQC -drop log -out2log -cut el $M -noex -out `newf` $pkl
done
