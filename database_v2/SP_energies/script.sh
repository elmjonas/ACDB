...
mkdir $f
for pkl in ../Articles/myllys19_sa_multibase_chrg/DLPNO_vtw16/database.pkl ../Articles/acdb_private/kubecka_1/database.pkl ../Articles/acdb_private/myllys_1/database.pkl ../Articles/acdb_old/DLPNO_vtw16/database.pkl ../Articles/acdb_monomers/DLPNO_vtw16/database.pkl ../Articles/acdb_monomers/DLPNO_vnw16/database.pkl ../Articles/knattrup23b_multiacid_multibase/MSA_SA_FA_NA_base/DFT/database.pkl ../Articles/knattrup23b_multiacid_multibase/SA_FA_NA_base/DFT/database.pkl ../Articles/knattrup23b_multiacid_multibase/Recalculated_Rasmussen_Clusteromics/DFT/database.pkl ../Articles/xie21_sa_multibase/G16/database.pkl ../Articles/kubecka23_sa_multibase/Xie-SI/database.pkl ../Articles/kubecka23_sa_multibase/DLPNO_DFT/database.pkl ../Articles/fomete23_sa_dma_malonic/database.pkl ../Articles/temelso18_sa_multibase/database.pkl ../Articles/li20_sa_am_dma/database.pkl ../Articles/myllys19_sa_am_dma/database.pkl ../Articles/besel19_sa_am_chrg/database.pkl ../Articles/kubecka19_sa_gd/database.pkl ../Articles/zanca20_sa_b_homJ/database.pkl ../Articles/ortega12_sa_am_dma/database.pkl ../Articles/leverentz13_sa_am_dma/database.pkl ../Articles/wang18_sa_am_ma/database.pkl ../Articles/chen20_msa/database.pkl ../Articles/paasonen12_sa_dma_tma/database.pkl ../Articles/kubecka23_sa_multibase/DFT/database_s1.pkl ../Articles/kubecka23_sa_multibase/DFT/database_s2.pkl ../Articles/kubecka23_sa_multibase/DFT/database_s3.pkl ../Articles/engsvang23_sa_pa_ca_multibase/DFT/database.pkl
do
...
mkdir $f
for pkl in ../Articles/myllys19_sa_multibase_chrg/DLPNO_vtw09/database.pkl ../Articles/acdb_private/kubecka_2/database.pkl ../Articles/acdb_private/elm_1/database.pkl ../Articles/acdb_old/DLPNO_vnw09/database.pkl ../Articles/shen19_msa/database.pkl ../Articles/acdb_monomers/DLPNO_vnw09/database.pkl ../Articles/acdb_monomers/DLPNO_vtw09/database.pkl ../Articles/xie21_sa_multibase/G09/database.pkl ../Articles/clusteromics_V_sa_msa_nta_fa_multibase/database_s3.pkl ../Articles/clusteromics_V_sa_msa_nta_fa_multibase/database_s2.pkl ../Articles/clusteromics_V_sa_msa_nta_fa_multibase/database_s1.pkl ../Articles/clusteromics_IV_sa_msa_nta_multibase/database_s1.pkl ../Articles/clusteromics_IV_sa_msa_nta_multibase/database_s2.pkl ../Articles/clusteromics_IV_sa_msa_nta_multibase/database_s3.pkl ../Articles/clusteromics_III_sa_msa_multibase/database.pkl ../Articles/clusteromics_I_sa_multibase/DLPNO/database.pkl ../Articles/clusteromics_I_sa_multibase/DFT/database.pkl ../Articles/kubecka23_sa_multibase/Xie-SI-G09/database.pkl ../Articles/rosati21_sa_msa/database.pkl ../Articles/rasmussen20_sa_w/database.pkl ../Articles/elm19_sa_pz ../Articles/rasmussen22_sa_msa_dma/database.pkl ../Articles/clusteromics_II_msa_multibase/database.pkl ../Articles/kupiainen12_sa_am_dma/database.pkl ../Articles/elm19_sa_pz/database.pkl 
do
  JKQC -drop out -cut el $M -noex -out `newf` $pkl
done
JKQC $f/f_*.pkl -noex -out $f/database.pkl
...
mkdir $f
for pkl in ../Articles/myllys19_sa_multibase_chrg/DLPNO_vtw16/database.pkl ../Articles/myllys19_sa_multibase_chrg/DLPNO_vtw09/database.pkl ../Articles/acdb_private/kubecka_1/database.pkl ../Articles/acdb_private/kubecka_1/database.pkl ../Articles/acdb_private/myllys_1/database.pkl ../Articles/acdb_private/kubecka_2/database.pkl ../Articles/acdb_monomers/DLPNO_vtw16/database.pkl ../Articles/acdb_monomers/DLPNO_vtw09/database.pkl ../Articles/kubecka23_sa_multibase/Xie-SI-G09/database.pkl ../Articles/besel19_sa_am_chrg/database.pkl ../Articles/kubecka19_sa_gd/database.pkl ../Articles/elm19_sa_pz/database.pkl 
do
...
mkdir $f
for pkl in ../Articles/clusteromics_III_sa_msa_multibase/database.pkl ../Articles/acdb_private/elm_1/database.pkl ../Articles/acdb_old/DLPNO_vnw09/database.pkl ../Articles/shen19_msa/database.pkl ../Articles/acdb_monomers/DLPNO_vnw09/database.pkl ../Articles/acdb_monomers/DLPNO_vnw16/database.pkl ../Articles/knattrup23b_multiacid_multibase/MSA_SA_FA_NA_base/DLPNO/database.pkl ../Articles/knattrup23b_multiacid_multibase/SA_FA_NA_base/DLPNO/database.pkl ../Articles/knattrup23b_multiacid_multibase/Recalculated_Rasmussen_Clusteromics/DLPNO/database.pkl ../Articles/clusteromics_V_sa_msa_nta_fa_multibase/database_s3.pkl ../Articles/clusteromics_V_sa_msa_nta_fa_multibase/database_s2.pkl ../Articles/clusteromics_V_sa_msa_nta_fa_multibase/database_s1.pkl ../Articles/clusteromics_IV_sa_msa_nta_multibase/database_s1.pkl ../Articles/clusteromics_IV_sa_msa_nta_multibase/database_s2.pkl ../Articles/clusteromics_IV_sa_msa_nta_multibase/database_s3.pkl ../Articles/clusteromics_I_sa_multibase/DLPNO/database.pkl ../Articles/kubecka23_sa_multibase/Xie-SI/database.pkl ../Articles/kubecka23_sa_multibase/DLPNO_DFT/database.pkl ../Articles/fomete23_sa_dma_malonic/database.pkl ../Articles/rosati21_sa_msa/database.pkl ../Articles/rasmussen20_sa_w/database.pkl ../Articles/elm19_sa_pz ../Articles/rasmussen22_sa_msa_dma/database.pkl ../Articles/chen20_msa/database.pkl ../Articles/clusteromics_II_msa_multibase/database.pkl ../Articles/kupiainen12_sa_am_dma/database.pkl
do
  JKQC -drop log -out2log -cut el $M -noex -out `newf` $pkl
done
for pkl in ../Articles/engsvang23_sa_pa_ca_multibase/DLPNO/database.pkl
do
...
f="B97-3c"
mkdir $f
for pkl in ../Articles/knattrup23_multiacid_multibase/Additional_files/extra_monomers_and_dimers/r2SCAN-3c/database.pkl ../Articles/engsvang23_sa_am/B97-3c_GFN1-xTB/extended/B97-3c/database.pkl ../Articles/engsvang23_sa_am/B97-3c_GFN1-xTB/equilibrium/B97-3c/database_s1.pkl ../Articles/engsvang23_sa_am/B97-3c_GFN1-xTB/equilibrium/B97-3c/database_s2.pkl
do
  JKQC -cut el $M -noex -out `newf` $pkl
done
JKQC $f/f_*.pkl -noex -out $f/database.pkl
